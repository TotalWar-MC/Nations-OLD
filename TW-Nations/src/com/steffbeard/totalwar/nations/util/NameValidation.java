...
public class NameValidation {
	...
	public static boolean isBlacklistName(String name) {
		...
		// Max name length
		if (name.length() > Settings.getMaxNameLength())
			return true;
		/*
	...
	public static boolean isValidName(String name) {
		...
		try {
			if (namePattern == null)
				namePattern = Pattern.compile(Settings.getNameCheckRegex(), Pattern.CASE_INSENSITIVE | Pattern.UNICODE_CHARACTER_CLASS);
	...
	public static boolean isValidString(String name) {
		...
		try {
			if (stringPattern == null)
				stringPattern = Pattern.compile(Settings.getStringCheckRegex(), Pattern.CASE_INSENSITIVE | Pattern.UNICODE_CHARACTER_CLASS);
	...
	public static String filterName(String input) {
		...
		return input.replaceAll(Settings.getNameFilterRegex(), "_").replaceAll(Settings.getNameRemoveRegex(), "");
	}
}
