...
public class NationsWorld extends NationsObject {

	/**
	 * 
	 * Need to add stuff for AllianceBlock, NationBlock and Alliances
	 * 
	 */
	
	private List<Town> towns = new ArrayList<>();
	private boolean isClaimable = true;
	private boolean isUsingPlotManagementDelete = Settings.isUsingPlotManagementDelete();
	private boolean isUsingPlotManagementMayorDelete = Settings.isUsingPlotManagementMayorDelete();
	private boolean isUsingPlotManagementRevert = Settings.isUsingPlotManagementRevert();
	private boolean isUsingPlotManagementWildRevert = Settings.isUsingPlotManagementWildRegen();
	private long plotManagementRevertSpeed = Settings.getPlotManagementSpeed();
	private long plotManagementWildRevertDelay = Settings.getPlotManagementWildRegenDelay();
	...
	private boolean isFire = Settings.isFire();
	private boolean isForceFire = Settings.isForcingFire();
	private boolean hasWorldMobs = Settings.isWorldMonstersOn();
	private boolean isForceTownMobs = Settings.isForcingMonsters();
	private boolean isExplosion = Settings.isExplosions();
	private boolean isForceExpl = Settings.isForcingExplosions();
	private boolean isEndermanProtect = Settings.getEndermanProtect();
	
	private boolean isDisablePlayerTrample = Settings.isPlayerTramplingCropsDisabled();
	private boolean isDisableCreatureTrample = Settings.isCreatureTramplingCropsDisabled();

	// TODO: private List<TownBlock> adminTownBlocks = new
	// ArrayList<TownBlock>();

	public NationsWorld(String name) {
		super(name);
	}
	...
	public List<String> getPlotManagementDeleteIds() {
		...
		if (plotManagementDeleteIds == null)
			return Settings.getPlotManagementDeleteIds();
		else
	...
	public List<String> getPlotManagementMayorDelete() {
		...
		if (plotManagementMayorDelete == null)
			return Settings.getPlotManagementMayorDelete();
		else
	...
	public List<String> getPlotManagementIgnoreIds() {
		...
		if (plotManagementIgnoreIds == null)
			return Settings.getPlotManagementIgnoreIds();
		else
	...
	public List<String> getPlotManagementWildRevertEntities() {
		...
		if (entityExplosionProtection == null)
			setPlotManagementWildRevertEntities(Settings.getWildExplosionProtectionEntities());
	...
	public List<String> getUnclaimedZoneIgnoreMaterials() {
		...
		if (unclaimedZoneIgnoreBlockMaterials == null)
			return Settings.getUnclaimedZoneIgnoreMaterials();
		else
	...
	public Boolean getUnclaimedZoneBuild() {
		...
		if (unclaimedZoneBuild == null)
			return Settings.getUnclaimedZoneBuildRights();
		else
	...
	public Boolean getUnclaimedZoneDestroy() {
		...
		if (unclaimedZoneDestroy == null)
			return Settings.getUnclaimedZoneDestroyRights();
		else
	...
	public Boolean getUnclaimedZoneSwitch() {
		...
		if (unclaimedZoneSwitch == null)
			return Settings.getUnclaimedZoneSwitchRights();
		else
	...
	public String getUnclaimedZoneName() {
		...
		if (unclaimedZoneName == null)
			return Settings.getUnclaimedZoneName();
		else
	...
	public Boolean getUnclaimedZoneItemUse() {
		...
		if (unclaimedZoneItemUse == null)
			return Settings.getUnclaimedZoneItemUseRights();
		else
