...
/**
 * 
 * Needs to be edited hardcore, is just a copy of Towny's confignodes
 * Maybe get someone who has no code experience to do it? lol
 * - zune
 * 
 */
...
public enum ConfigNodes {
	...
	VERSION(
			"version.version",
			"",
			"# This is the current version of Nations.  Please do not edit."),
	LAST_RUN_VERSION(
