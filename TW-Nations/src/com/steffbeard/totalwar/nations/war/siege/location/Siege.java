...
public class Siege {
	...
	public long getTimeUntilSurrenderIsAllowedMillis() {
		return (long)((Settings.getWarSiegeMinSiegeDurationBeforeSurrenderHours() * ONE_HOUR_IN_MILLIS) - getDurationMillis());
	}

	public long getTimeUntilAbandonIsAllowedMillis() {
		return (long)((Settings.getWarSiegeMinSiegeDurationBeforeAbandonHours() * ONE_HOUR_IN_MILLIS) - getDurationMillis());
	}
